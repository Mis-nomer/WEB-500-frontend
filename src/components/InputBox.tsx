...
export const InputBox = () => {
  ...
  return (
    <main className='flex -mt-20 h-full justify-center items-center'>
      <img className='inside object-cover -z-10 absolute' src='/public/boxes/inside.svg' alt='' />
      <div className='input-box border-2 border-black relative bg-white w-[21vw] h-[40vh]'>
